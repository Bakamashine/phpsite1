...
<!-- <section class="section-2">
    <h1 class="text-center">Поиск машин</h1>
    <div class="flex-center">
        <form about="" method="get">

            <div>
                <legend class="section-2-legend">Имя машины</legend>
                <input type="text" class="section-2-input" name="name">
            </div>
            <div>
                <legend class="section-2-legend">Цена машины</legend>
                <input type="text" class="section-2-input" name="price">
            </div>
            <div>
                <legend class="section-2-legend">Цена</legend>
                <div class="flex">
                    <p>От</p>
                    <input class="section-2-input" name="price_min" type="text" value="" />
                    <p>До</p>
                    <input class="section-2-input" name="price_max" type="text" value="" />
                </div>
            </div>

            <div>
                <legend class="section-2-legend">Город</legend>
                <input type="text" class="section-2-input" name="city">
            </div>
            <div>
                <legend class="section-2-legend">Марка</legend>
                <input type="text" class="section-2-input" name="marks">
            </div>

            <div class="otstup-button">
